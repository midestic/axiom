let test3 = "/images/test3.jpg";

export default function Testimonial2() {
  return (
    <div className="w-[70%] mx-auto py-[50px] max-md:w-[100%]">
      <div className="w-fit h-fit  mx-auto">
        <img className="mx-auto  rounded-full" src={test3} alt="" />
      </div>
      ...
      <div className="text-center">
        <p className="text-[19px] text-[#080337] font-bold">Sandy Williams</p>
        <p className="text-[16px] text-gray-500">CEO, Business Co.</p>
      </div>
    </div>
  );
}
